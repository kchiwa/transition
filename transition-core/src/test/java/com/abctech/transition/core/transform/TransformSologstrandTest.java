...
public class TransformSologstrandTest {

    private final static Logger log = LoggerFactory.getLogger(TransformSologstrandTest.class);
    private static final String SOLOGSTRAND = CustomerFormat.SOLOGSTRAND.toTextValue();
