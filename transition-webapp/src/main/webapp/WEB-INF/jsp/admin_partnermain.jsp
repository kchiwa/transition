...
window.onload=createhintbox
        ...
        <div class="span-24 last" id="header">
           <h3 class="grey">Partner Lookup</h3><hr />
        </div>
        ...
        <div class="span-5 colborder" id="sidebar">
                  ...
                  <div id="searchFile">
                     <form:form method="POST" action="./admin_partnermain.html" commandName="partnerForm">

                      <div class="span-2 margintopsearch"><label for="id" class="searchField">Login</label></div>
                      <div class="span-3 last">
                        <form:select path="id" id="id" name="id" class="width100 grey">
                      ...
                      <div class="span-2 margintopsearch"><label for="zClientID" class="searchField">ZClient ID</label></div>
                      <div class="span-3 last"><form:input path="zClientID" class="search" name="zClientID" id="zClientID" /></div>

                      <div class="span-2 margintopsearch"><label for="identifier" class="searchField">Identifier</label></div>
                      <div class="span-3 last"><form:input path="identifier" class="search" name="identifier" id="identifier" /></div>
                  ...
                  <div class="span-5 last">
                       <a href="./admin_partneradd.html" target="blank">Create new Partner</a>
                  </div>
        ...
        <div class="span-18 last grey" id="content">
            ...
            <c:choose>
            <c:when test="${!empty partnerModelList}">

                <table summary="Ad List table"  border="0" cellspacing="0" cellpadding="0">
                  <thead>
                  <tr>
                    <th class="span-3">Login</th>
                    <th class="span-4">Identifier</th>
                    <th class="span-3">ZClient ID</th>
                    <th class="span-3">Desc</th>
                    <th class="span-3">Password</th>
                  ...
                  <tbody>
                          <c:forEach items="${partnerModelList}" var="partnerModel">
                          <form method="POST" action="./admin_partnermain.html">
                          <input type="hidden" name="requestPage" value="${partnerForm.requestPage}">
                          <tr>
                            <td>${partnerModel.partnerLoginModel.login}</td>
                            <td>${partnerModel.identifier}</td>
                            <td>${partnerModel.zClientId}</td>
                            <td>${partnerModel.description}</td>
                            <td>${partnerModel.partnerMapPassword}</td>
                           </form>




                            <td><a href="admin_partnerdelete.html?delete_id=${partnerModel.id}" onclick="return confirm('Delete ${partnerModel.identifier} ?');">Delete</a></td>
                          </c:forEach>
                  </tbody>
                </table>
                ...
                <div id="page" class="span-18 last grey">
                    <form method="POST" action="./admin_partnermain.html">
                        ...
                        <input type="hidden" name="customerFormat" value="${partnerForm.zClientID}"/>
                        <input type="hidden" name="protocol" value="${partnerForm.identifier}"/>
                    </form>
                </div>
                    ...
                    <c:if test="${partnerForm.requestPage != Paging.prevPage}">
                        <div>
                            <form method="POST" action="./admin_partnermain.html">
                                ...
                                <input type="hidden" name="requestPage" value="${Paging.prevPage}"/>
                                <input type="hidden" name="login" value="${partnerForm.login}"/>
                                <input type="hidden" name="customerFormat" value="${partnerForm.zClientID}"/>
                                <input type="hidden" name="protocol" value="${partnerForm.identifier}"/>
                            </form>
