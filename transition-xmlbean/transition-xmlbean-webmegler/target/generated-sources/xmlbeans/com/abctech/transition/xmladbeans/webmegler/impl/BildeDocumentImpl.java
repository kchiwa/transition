 ...
 */
public class BildeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.webmegler.BildeDocument
{
     ...
     */
    public com.abctech.transition.xmladbeans.webmegler.BildeDocument.Bilde getBilde()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.webmegler.BildeDocument.Bilde target = null;
            target = (com.abctech.transition.xmladbeans.webmegler.BildeDocument.Bilde)get_store().find_element_user(BILDE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setBilde(com.abctech.transition.xmladbeans.webmegler.BildeDocument.Bilde bilde)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class BildeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.webmegler.BildeDocument.Bilde
    {
        private static final long serialVersionUID = 1L;
