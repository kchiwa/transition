 ...
 */
public class LinkDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.itmakeriet.LinkDocument
{
     ...
     */
    public com.abctech.transition.xmladbeans.itmakeriet.LinkDocument.Link getLink()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.itmakeriet.LinkDocument.Link target = null;
            target = (com.abctech.transition.xmladbeans.itmakeriet.LinkDocument.Link)get_store().find_element_user(LINK$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLink(com.abctech.transition.xmladbeans.itmakeriet.LinkDocument.Link link)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public static class LinkImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.abctech.transition.xmladbeans.itmakeriet.LinkDocument.Link
    {
        private static final long serialVersionUID = 1L;
