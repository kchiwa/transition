 ...
 */
public class PDFDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.itmakeriet.PDFDocument
{
    private static final long serialVersionUID = 1L;
    
    public PDFDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName PDF$0 = 
     ...
     */
    public com.abctech.transition.xmladbeans.itmakeriet.PDFDocument.PDF getPDF()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.itmakeriet.PDFDocument.PDF target = null;
            target = (com.abctech.transition.xmladbeans.itmakeriet.PDFDocument.PDF)get_store().find_element_user(PDF$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPDF(com.abctech.transition.xmladbeans.itmakeriet.PDFDocument.PDF pdf)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.itmakeriet.PDFDocument.PDF)get_store().add_element_user(PDF$0);
            }
            target.set(pdf);
        }
    }
     ...
     */
    public static class PDFImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.abctech.transition.xmladbeans.itmakeriet.PDFDocument.PDF
    {
        private static final long serialVersionUID = 1L;
        
        public PDFImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected PDFImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
