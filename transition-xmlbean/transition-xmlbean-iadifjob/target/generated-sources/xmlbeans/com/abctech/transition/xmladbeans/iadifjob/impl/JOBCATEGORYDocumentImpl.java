 ...
 */
public class JOBCATEGORYDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifjob.JOBCATEGORYDocument
{
     ...
     */
    public com.abctech.transition.xmladbeans.iadifjob.JOBCATEGORYDocument.JOBCATEGORY getJOBCATEGORY()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.iadifjob.JOBCATEGORYDocument.JOBCATEGORY target = null;
            target = (com.abctech.transition.xmladbeans.iadifjob.JOBCATEGORYDocument.JOBCATEGORY)get_store().find_element_user(JOBCATEGORY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setJOBCATEGORY(com.abctech.transition.xmladbeans.iadifjob.JOBCATEGORYDocument.JOBCATEGORY jobcategory)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.iadifjob.JOBCATEGORYDocument.JOBCATEGORY)get_store().add_element_user(JOBCATEGORY$0);
            }
     ...
     * This is a complex type.
     */
    public static class JOBCATEGORYImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifjob.JOBCATEGORYDocument.JOBCATEGORY
    {
        private static final long serialVersionUID = 1L;
