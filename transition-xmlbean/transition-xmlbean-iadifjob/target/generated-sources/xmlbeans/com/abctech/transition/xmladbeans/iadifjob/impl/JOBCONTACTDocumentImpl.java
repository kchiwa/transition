 ...
 */
public class JOBCONTACTDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifjob.JOBCONTACTDocument
{
     ...
     */
    public com.abctech.transition.xmladbeans.iadifjob.JOBCONTACTDocument.JOBCONTACT getJOBCONTACT()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.iadifjob.JOBCONTACTDocument.JOBCONTACT target = null;
            target = (com.abctech.transition.xmladbeans.iadifjob.JOBCONTACTDocument.JOBCONTACT)get_store().find_element_user(JOBCONTACT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setJOBCONTACT(com.abctech.transition.xmladbeans.iadifjob.JOBCONTACTDocument.JOBCONTACT jobcontact)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.iadifjob.JOBCONTACTDocument.JOBCONTACT)get_store().add_element_user(JOBCONTACT$0);
            }
     ...
     * This is a complex type.
     */
    public static class JOBCONTACTImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifjob.JOBCONTACTDocument.JOBCONTACT
    {
        private static final long serialVersionUID = 1L;
