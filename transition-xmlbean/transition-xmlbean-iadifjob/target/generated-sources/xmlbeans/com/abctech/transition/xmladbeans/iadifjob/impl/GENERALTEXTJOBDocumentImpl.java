 ...
 */
public class GENERALTEXTJOBDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifjob.GENERALTEXTJOBDocument
{
     ...
     */
    public com.abctech.transition.xmladbeans.iadifjob.GENERALTEXTJOBDocument.GENERALTEXTJOB getGENERALTEXTJOB()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.iadifjob.GENERALTEXTJOBDocument.GENERALTEXTJOB target = null;
            target = (com.abctech.transition.xmladbeans.iadifjob.GENERALTEXTJOBDocument.GENERALTEXTJOB)get_store().find_element_user(GENERALTEXTJOB$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGENERALTEXTJOB(com.abctech.transition.xmladbeans.iadifjob.GENERALTEXTJOBDocument.GENERALTEXTJOB generaltextjob)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.iadifjob.GENERALTEXTJOBDocument.GENERALTEXTJOB)get_store().add_element_user(GENERALTEXTJOB$0);
            }
     ...
     * This is a complex type.
     */
    public static class GENERALTEXTJOBImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifjob.GENERALTEXTJOBDocument.GENERALTEXTJOB
    {
        private static final long serialVersionUID = 1L;
