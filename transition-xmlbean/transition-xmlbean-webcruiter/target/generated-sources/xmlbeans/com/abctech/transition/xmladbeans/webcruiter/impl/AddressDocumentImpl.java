 ...
 */
public class AddressDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.webcruiter.AddressDocument
{
    ...
    public com.abctech.transition.xmladbeans.webcruiter.AddressDocument.Address getAddress()
    {
        synchronized (monitor())
        {
            ...
            target = (com.abctech.transition.xmladbeans.webcruiter.AddressDocument.Address)get_store().find_element_user(ADDRESS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setAddress(com.abctech.transition.xmladbeans.webcruiter.AddressDocument.Address address)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.webcruiter.AddressDocument.Address)get_store().add_element_user(ADDRESS$0);
            }
            target.set(address);
        }
    }
     ...
     * This is a complex type.
     */
    public static class AddressImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.webcruiter.AddressDocument.Address
    {
        private static final long serialVersionUID = 1L;
