 ...
 */
public class StatusDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.webcruiter.StatusDocument
{
    ...
    public com.abctech.transition.xmladbeans.webcruiter.StatusDocument.Status getStatus()
    {
        synchronized (monitor())
        {
            ...
            target = (com.abctech.transition.xmladbeans.webcruiter.StatusDocument.Status)get_store().find_element_user(STATUS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setStatus(com.abctech.transition.xmladbeans.webcruiter.StatusDocument.Status status)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.webcruiter.StatusDocument.Status)get_store().add_element_user(STATUS$0);
            }
            target.set(status);
        }
    }
     ...
     */
    public static class StatusImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.abctech.transition.xmladbeans.webcruiter.StatusDocument.Status
    {
        private static final long serialVersionUID = 1L;
