 ...
 */
public class ContactDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.webcruiter.ContactDocument
{
     ...
     */
    public com.abctech.transition.xmladbeans.webcruiter.ContactDocument.Contact getContact()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.webcruiter.ContactDocument.Contact target = null;
            target = (com.abctech.transition.xmladbeans.webcruiter.ContactDocument.Contact)get_store().find_element_user(CONTACT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setContact(com.abctech.transition.xmladbeans.webcruiter.ContactDocument.Contact contact)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ContactImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.webcruiter.ContactDocument.Contact
    {
        private static final long serialVersionUID = 1L;
        ...
        public com.abctech.transition.xmladbeans.webcruiter.AddressDocument.Address getAddress()
        {
            synchronized (monitor())
            {
                ...
                target = (com.abctech.transition.xmladbeans.webcruiter.AddressDocument.Address)get_store().find_element_user(ADDRESS$10, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public void setAddress(com.abctech.transition.xmladbeans.webcruiter.AddressDocument.Address address)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (com.abctech.transition.xmladbeans.webcruiter.AddressDocument.Address)get_store().add_element_user(ADDRESS$10);
                }
                target.set(address);
            }
        }
