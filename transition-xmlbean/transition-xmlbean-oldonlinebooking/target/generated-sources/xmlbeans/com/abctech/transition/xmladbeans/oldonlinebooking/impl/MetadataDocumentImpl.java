 ...
 */
public class MetadataDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.oldonlinebooking.MetadataDocument
{
     ...
     */
    public com.abctech.transition.xmladbeans.oldonlinebooking.MetadataDocument.Metadata getMetadata()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.oldonlinebooking.MetadataDocument.Metadata target = null;
            target = (com.abctech.transition.xmladbeans.oldonlinebooking.MetadataDocument.Metadata)get_store().find_element_user(METADATA$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setMetadata(com.abctech.transition.xmladbeans.oldonlinebooking.MetadataDocument.Metadata metadata)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.oldonlinebooking.MetadataDocument.Metadata)get_store().add_element_user(METADATA$0);
            }
            target.set(metadata);
        }
    }
     ...
     */
    public static class MetadataImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.abctech.transition.xmladbeans.oldonlinebooking.MetadataDocument.Metadata
    {
        private static final long serialVersionUID = 1L;
        ...
        protected MetadataImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
