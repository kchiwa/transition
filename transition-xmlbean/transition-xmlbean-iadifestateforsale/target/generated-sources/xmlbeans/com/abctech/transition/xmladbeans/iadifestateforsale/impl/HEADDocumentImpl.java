 ...
 */
public class HEADDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifestateforsale.HEADDocument
{
     ...
     * This is a complex type.
     */
    public static class HEADImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifestateforsale.HEADDocument.HEAD
    {
        private static final long serialVersionUID = 1L;
        ...
        public com.abctech.transition.xmladbeans.iadifestateforsale.EMAILFEEDBACKDocument.EMAILFEEDBACK getEMAILFEEDBACK()
        {
            synchronized (monitor())
            {
                ...
                target = (com.abctech.transition.xmladbeans.iadifestateforsale.EMAILFEEDBACKDocument.EMAILFEEDBACK)get_store().find_element_user(EMAILFEEDBACK$6, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public void setEMAILFEEDBACK(com.abctech.transition.xmladbeans.iadifestateforsale.EMAILFEEDBACKDocument.EMAILFEEDBACK emailfeedback)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (com.abctech.transition.xmladbeans.iadifestateforsale.EMAILFEEDBACKDocument.EMAILFEEDBACK)get_store().add_element_user(EMAILFEEDBACK$6);
                }
