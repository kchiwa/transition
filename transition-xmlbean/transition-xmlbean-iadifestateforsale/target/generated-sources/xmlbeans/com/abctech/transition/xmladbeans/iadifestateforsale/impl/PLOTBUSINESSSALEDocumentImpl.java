 ...
 */
public class PLOTBUSINESSSALEDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifestateforsale.PLOTBUSINESSSALEDocument
{
    private static final long serialVersionUID = 1L;
    
    public PLOTBUSINESSSALEDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName PLOTBUSINESSSALE$0 = 
        new javax.xml.namespace.QName("", "PLOT_BUSINESS_SALE");
    
    
    /**
     * Gets the "PLOT_BUSINESS_SALE" element
     */
    public com.abctech.transition.xmladbeans.iadifestateforsale.PLOTBUSINESSSALEDocument.PLOTBUSINESSSALE getPLOTBUSINESSSALE()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.iadifestateforsale.PLOTBUSINESSSALEDocument.PLOTBUSINESSSALE target = null;
            target = (com.abctech.transition.xmladbeans.iadifestateforsale.PLOTBUSINESSSALEDocument.PLOTBUSINESSSALE)get_store().find_element_user(PLOTBUSINESSSALE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPLOTBUSINESSSALE(com.abctech.transition.xmladbeans.iadifestateforsale.PLOTBUSINESSSALEDocument.PLOTBUSINESSSALE plotbusinesssale)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.iadifestateforsale.PLOTBUSINESSSALEDocument.PLOTBUSINESSSALE)get_store().add_element_user(PLOTBUSINESSSALE$0);
            }
            target.set(plotbusinesssale);
        }
    }
     ...
     */
    public com.abctech.transition.xmladbeans.iadifestateforsale.PLOTBUSINESSSALEDocument.PLOTBUSINESSSALE addNewPLOTBUSINESSSALE()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class PLOTBUSINESSSALEImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifestateforsale.PLOTBUSINESSSALEDocument.PLOTBUSINESSSALE
    {
        private static final long serialVersionUID = 1L;
        
        public PLOTBUSINESSSALEImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
