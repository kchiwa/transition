 ...
 */
public class FINANCIALAGENTDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifestateforsale.FINANCIALAGENTDocument
{
    private static final long serialVersionUID = 1L;
    
    public FINANCIALAGENTDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName FINANCIALAGENT$0 = 
     ...
     */
    public com.abctech.transition.xmladbeans.iadifestateforsale.FINANCIALAGENTDocument.FINANCIALAGENT getFINANCIALAGENT()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.iadifestateforsale.FINANCIALAGENTDocument.FINANCIALAGENT target = null;
            target = (com.abctech.transition.xmladbeans.iadifestateforsale.FINANCIALAGENTDocument.FINANCIALAGENT)get_store().find_element_user(FINANCIALAGENT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setFINANCIALAGENT(com.abctech.transition.xmladbeans.iadifestateforsale.FINANCIALAGENTDocument.FINANCIALAGENT financialagent)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.iadifestateforsale.FINANCIALAGENTDocument.FINANCIALAGENT)get_store().add_element_user(FINANCIALAGENT$0);
            }
     ...
     * This is a complex type.
     */
    public static class FINANCIALAGENTImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.iadifestateforsale.FINANCIALAGENTDocument.FINANCIALAGENT
    {
        private static final long serialVersionUID = 1L;
        
        public FINANCIALAGENTImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
