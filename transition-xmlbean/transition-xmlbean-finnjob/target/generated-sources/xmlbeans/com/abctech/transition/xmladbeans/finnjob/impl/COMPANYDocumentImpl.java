 ...
 */
public class COMPANYDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.finnjob.COMPANYDocument
{
     ...
     */
    public com.abctech.transition.xmladbeans.finnjob.COMPANYDocument.COMPANY getCOMPANY()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.finnjob.COMPANYDocument.COMPANY target = null;
            target = (com.abctech.transition.xmladbeans.finnjob.COMPANYDocument.COMPANY)get_store().find_element_user(COMPANY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCOMPANY(com.abctech.transition.xmladbeans.finnjob.COMPANYDocument.COMPANY company)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.finnjob.COMPANYDocument.COMPANY)get_store().add_element_user(COMPANY$0);
            }
            target.set(company);
        }
    }
     ...
     * This is a complex type.
     */
    public static class COMPANYImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.finnjob.COMPANYDocument.COMPANY
    {
        private static final long serialVersionUID = 1L;
