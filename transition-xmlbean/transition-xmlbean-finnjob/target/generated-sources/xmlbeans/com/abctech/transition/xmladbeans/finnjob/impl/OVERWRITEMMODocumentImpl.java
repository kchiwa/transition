 ...
 */
public class OVERWRITEMMODocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.finnjob.OVERWRITEMMODocument
{
    ...
    public com.abctech.transition.xmladbeans.finnjob.OVERWRITEMMODocument.OVERWRITEMMO getOVERWRITEMMO()
    {
        synchronized (monitor())
        {
            ...
            target = (com.abctech.transition.xmladbeans.finnjob.OVERWRITEMMODocument.OVERWRITEMMO)get_store().find_element_user(OVERWRITEMMO$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setOVERWRITEMMO(com.abctech.transition.xmladbeans.finnjob.OVERWRITEMMODocument.OVERWRITEMMO overwritemmo)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.finnjob.OVERWRITEMMODocument.OVERWRITEMMO)get_store().add_element_user(OVERWRITEMMO$0);
            }
     ...
     * This is a complex type.
     */
    public static class OVERWRITEMMOImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.finnjob.OVERWRITEMMODocument.OVERWRITEMMO
    {
        private static final long serialVersionUID = 1L;
