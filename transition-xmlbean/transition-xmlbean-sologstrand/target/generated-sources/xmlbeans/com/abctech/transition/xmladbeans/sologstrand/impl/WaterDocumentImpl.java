 ...
 */
public class WaterDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.sologstrand.WaterDocument
{
    private static final long serialVersionUID = 1L;
    
    public WaterDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName WATER$0 = 
     ...
     */
    public com.abctech.transition.xmladbeans.sologstrand.WaterDocument.Water getWater()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.sologstrand.WaterDocument.Water target = null;
            target = (com.abctech.transition.xmladbeans.sologstrand.WaterDocument.Water)get_store().find_element_user(WATER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setWater(com.abctech.transition.xmladbeans.sologstrand.WaterDocument.Water water)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.sologstrand.WaterDocument.Water)get_store().add_element_user(WATER$0);
            }
            target.set(water);
        }
    }
     ...
     */
    public static class WaterImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.abctech.transition.xmladbeans.sologstrand.WaterDocument.Water
    {
        private static final long serialVersionUID = 1L;
        
        public WaterImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected WaterImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
