 ...
 */
public class ElectricityDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.sologstrand.ElectricityDocument
{
    private static final long serialVersionUID = 1L;
    
    public ElectricityDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.abctech.transition.xmladbeans.sologstrand.ElectricityDocument.Electricity getElectricity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.sologstrand.ElectricityDocument.Electricity target = null;
            target = (com.abctech.transition.xmladbeans.sologstrand.ElectricityDocument.Electricity)get_store().find_element_user(ELECTRICITY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setElectricity(com.abctech.transition.xmladbeans.sologstrand.ElectricityDocument.Electricity electricity)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public static class ElectricityImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.abctech.transition.xmladbeans.sologstrand.ElectricityDocument.Electricity
    {
        private static final long serialVersionUID = 1L;
        
        public ElectricityImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected ElectricityImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
