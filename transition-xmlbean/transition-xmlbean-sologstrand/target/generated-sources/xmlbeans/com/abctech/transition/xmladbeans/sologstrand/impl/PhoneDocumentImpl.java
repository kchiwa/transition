 ...
 */
public class PhoneDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.abctech.transition.xmladbeans.sologstrand.PhoneDocument
{
     ...
     */
    public com.abctech.transition.xmladbeans.sologstrand.PhoneDocument.Phone getPhone()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.abctech.transition.xmladbeans.sologstrand.PhoneDocument.Phone target = null;
            target = (com.abctech.transition.xmladbeans.sologstrand.PhoneDocument.Phone)get_store().find_element_user(PHONE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPhone(com.abctech.transition.xmladbeans.sologstrand.PhoneDocument.Phone phone)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.abctech.transition.xmladbeans.sologstrand.PhoneDocument.Phone)get_store().add_element_user(PHONE$0);
            }
            target.set(phone);
        }
    }
     ...
     */
    public static class PhoneImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.abctech.transition.xmladbeans.sologstrand.PhoneDocument.Phone
    {
        private static final long serialVersionUID = 1L;
        ...
        protected PhoneImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
